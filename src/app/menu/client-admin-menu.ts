export const CLIENT_ADMIN_MENU_CONSTANTS = {
    'featureCategories':
    {
            others: [
                       {
                       ...
                       },
                       {
                             ...
                             features: [
                                  ...
                                  {
                                     id: 2,
                                     baseIcon: 'vendormanagement.svg',
                                     crud: true,
                                     description: 'Vendor Management',
                                     name: 'Vendor List',
                                     state: '/vendor/list',
                                     translation: 'sidebar.nav.customer.vendor'
                                  },
                                  {
                                       id: 3,
                       ...
                       },
                       {
                            ...
                            core: false,
                            state: '/product',
                            parentUrl: ['board-manufacturer','machine-manufacturer','product-type','assigned-vendor-product','assigned-company-product','product-wizard'],
                            ...
                            features: [
                                   ...
                                   {      id: 4,
                                          ...
                                          translation: 'sidebar.nav.productManagement.vendorProduct'
                                   },
                                   {      id: 5,
                                         baseIcon: 'companymanagement.svg',
                                         crud: true,
...

                     {
                             ...
                             features: [
                                    {      id: 1,
                                           ...
                                           description: 'Report Management',
                                           name: 'Report  Management',
                                           state: '/report/client-vendor',
                                           translation: 'sidebar.nav.report.vendorReport'
                                    },
                                    {      id: 2,
                                           baseIcon: 'companymanagement.svg',
                                           crud: true,
                                    ...
                                    {      id: 3,
                                           ...
                                           description: 'Report Management',
                                           name: 'Report  Management',
                                           state: '/report/vendor-error',
                                           translation: 'sidebar.nav.report.vendorError'
                                    },
                                    {      id: 4,
                                           baseIcon: 'error.svg',
                                           crud: true,
