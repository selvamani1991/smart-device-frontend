...
export class EditComponent implements OnInit {
    ...
    setting = {
        ...
        pageTitle: COMPANY_CONSTANTS.LABEL.COMPANY_EDIT,
        pageDesc: COMPANY_CONSTANTS.LABEL.COMPANY_EDIT_DESC
    };
    steps= [];
    ...
    createCompanyForm(): FormGroup {
        if(this.currentUser.userType=='clientAdmin'){
            ...
            return this.companyForm = this._formBuilder.group({
                ...
                productCount          : [this.company.productCount],
                buildingCount         : [this.company.buildingCount],
                subscriptionCount     : [this.company.subscriptionCount],
    ...
    loadClient() {
        ...
        data => {
           ...
           this.breadCrumService.pushStep('Edit' + ' ' + this.client.companyNickName, COMPANY_CONSTANTS.URL.COMPANY_EDIT, false);
